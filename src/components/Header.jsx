...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center  text-black h-24 mx-auto px-4 w-full bg-[#FEBB37]">
      ...
      <section className={(menuIcon && !isLargeScreen ) ? "fixed left-0 top-0 w-[50%] h-full border-r border-r-gray-400 bg-black ease-in-out duration-500" : "fixed left-[-100%]"}>
